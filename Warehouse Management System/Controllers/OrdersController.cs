...
namespace Warehouse_Management_System.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var inventoryManagementContext = _context.Orders.Include(o => o.Customer).Include(o => o.User);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,CustomerId,UserId,OrderDate,TotalAmount")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
